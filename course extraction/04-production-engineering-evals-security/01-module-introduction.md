...
> Agent-authored source note: Transcribed from the authenticated course screen [S01](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/2gf8jaub9q0dj/Developer_M4_vF2.html#S01). The course text below is verbatim; only Markdown formatting and whitespace were adapted.

## Course text (verbatim)

### What you will be able to do by the end

*Module 4 · Orientation · 2 min*
