...
Sources: [S05](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S05) · [S06](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S06)

## S05 — Teaching

**Extended Thinking · 12 min**
...
**Prompt:** Classify 50,000 support tickets into three labels overnight.

- **Interactive option:** Never do this.
- **Interactive option:** Leave it off.
- **Interactive option:** Enable it, budget for the planning step.

**Prompt:** Plan a multi-step refactor where each step depends on the previous one.

- **Interactive option:** Never do this.
- **Interactive option:** Leave it off.
- **Interactive option:** Enable it, budget for the planning step.

**Prompt:** Strip the thinking block out of conversation history to save context before the next tool call.
