...
Sources: [S07](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S07) · [S08](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S08) · [S09](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S09)

## S07 — Teaching

**Tool-use and Schema Design · 20 min**
...
**Handles well** Routing Claude to the right tool reliably when descriptions are specific and exclusion conditions are stated.
...
**Tool-use and Schema Design · 5 min**
...
**Tool-use and Schema Design · 4 min**
...
- **Interactive option A:** Update the description on get_account_balance to add an exclusion condition.
- **Interactive option B:** Correct the tool_use_id on the tool_result block so it matches the id issued in the assistant turn.
- **Interactive option C:** Add a required array to the tool's input_schema so account_id cannot be omitted.
