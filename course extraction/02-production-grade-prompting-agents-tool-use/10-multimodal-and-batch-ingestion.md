...
Sources: [S24](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S24) · [S25](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S25) · [S26](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S26)

## S24 — Teaching

**Multimodal and Batch Ingestion · 13 min**
...
**Multimodal and Batch Ingestion · 4 min**
...
**Multimodal and Batch Ingestion · 3 min**
...
**Prompt:** A reference product diagram used in every request your pipeline makes

- **Interactive option:** Message Batches API: submit all requests in one batch call, poll for completion
- **Interactive option:** Files API: upload once, reference file_id in each request
- **Interactive option:** Inline base64: encode and include directly in the message block

**Prompt:** A one-off screenshot of a UI bug, submitted by a support engineer in a single request

- **Interactive option:** Message Batches API: submit all requests in one batch call, poll for completion
- **Interactive option:** Files API: upload once, reference file_id in each request
- **Interactive option:** Inline base64: encode and include directly in the message block

**Prompt:** A job classifying 5,000 customer feedback responses
