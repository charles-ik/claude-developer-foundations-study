...
Sources: [S16](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S16) · [S17](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S17) · [S18](https://anthropic-partners.skilljar.com/content/wp/4hdejjwplbrm/3fpv056zo4wp4/Developer_M2_vF2.html#S18)

## S16 — Teaching

**Agent Construction · 22 min**
...
- **Response field:** Write the tool description here…

#### Gap 2: Write the HITL checkpoint code

- **Response field:** Write the HITL checkpoint code here…
- **Interactive control:** Reveal model answers
...
- **Interactive control:** Both gaps match · pass
- **Interactive control:** Missed one · retry
